...
$string['useexperimentalui'] = 'Alternative nested discussion view';
$string['useexperimentalui_desc'] = 'If enabled, forum discussions using the nested layout will display with an alternative view featuring inline replies and a different threading style. This applies to all users who have not explicitly set their own forum preference.';
$string['useexperimentalui_help'] = 'If enabled, forum discussions using the nested layout will display with an alternative view featuring inline replies and a different threading style.';

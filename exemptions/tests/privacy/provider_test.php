...
class provider_test extends provider_testcase {
    ...
    /**
     * Test confirming that contexts of exemptiond items can be added to the contextlist.
     */
    ...
    /**
     * Test confirming that user ID's of exemptiond items can be added to the userlist.
     */
    ...
    public function test_get_exemptions_info_for_user(): void {
        ...
        // Get the exemptions info for user2 in the course1 context (user2 has not exemptiond course1).

...
interface exemption_repository_interface {
     ...
     *
     * @param int $userid the id of the user to which the exemption belongs.
     ...
     * @param int $contextid the contextid of the item which was exemptiond.
     * @return exemption the exemption.
     */
    public function find_exemption(int $userid, string $component, string $itemtype, int $itemid, int $contextid): exemption;
}

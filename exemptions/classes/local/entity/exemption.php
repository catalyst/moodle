...
class exemption {
    ...
    /** @var string $component the frankenstyle name of the component containing the exemptiond item. E.g. 'core_course'.*/
    public $component;
     ...
     * @param string $component the frankenstyle name of the component containing the exemptiond item. E.g. 'core_course'.

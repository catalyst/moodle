...
$string['exemptionmissinggroupid'] = 'Missing group ID for group penalty exemption';
$string['exemptionmissinguserid'] = 'Missing user ID for user penalty exemption';
...
$string['gradepenaltyalreadyapplied'] = 'A penalty has already been applied to this grade (ID: {$a})';
...
$string['privacy:metadata:exemptions'] = 'Stores references to grade penalty exemptions.';
$string['privacy:metadata:exemptions:itemid'] = 'The exemption type item identifier which can be a user ID';
$string['privacy:metadata:exemptions:reason'] = 'The reason for the exemption';
$string['privacy:metadata:exemptions:reasonformat'] = 'The format of the reason for the exemption';
$string['privacy:metadata:exemptions:timecreated'] = 'The time when the exemption was created';
$string['privacy:metadata:exemptions:timemodified'] = 'The time when the exemption was last modified';
$string['privacy:metadata:exemptions:usermodified'] = 'The user who last modified the exemption';
...
$string['report:penaltyexemption'] = 'Penalty exemption';
$string['report:itemtype'] = 'Exemption type';
$string['report:itemtype:user'] = 'User';
$string['report:itemtype:group'] = 'Group';
$string['report:scope'] = 'Exemption scope';
$string['report:scope:system'] = 'Site';
$string['report:scope:course'] = 'Course';
$string['report:scope:module'] = 'Activity';
$string['report:scope:unknown'] = 'Unknown';
$string['report:scope:navigate'] = 'Manage scope';
$string['report:reason'] = 'Exemption reason';

...
final class exemption_test extends penalty_testcase {
    ...
    public function test_exempt_user(): void {
        ...
        // Exempt users.
        $exemption = penalty_exemption::exempt_user('gradepenalty_duedate', $user1->id, $coursectx->id, 'Course exemption');
        penalty_exemption::exempt_user('gradepenalty_duedate', $user2->id, $assign2ctx->id, 'Activity exemption');
    ...
    public function test_exempt_group(): void {
        ...
        // Exempt groups.
        $exemption = penalty_exemption::exempt_group('gradepenalty_duedate', $group1->id, $coursectx->id, 'Course exemption');
        penalty_exemption::exempt_group('gradepenalty_duedate', $group2->id, $assign2ctx->id, 'Activity exemption');

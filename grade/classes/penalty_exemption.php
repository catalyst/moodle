...
final class penalty_exemption {
     ...
     *
     * @param string $component The frankenstyle name of the component that created the exemption (e.g. 'gradepenalty_duedate').
    ...
    /**
     * Get the exemption component.
     *
     * @return string The exemption component.
     */
     ...
     *
     * @param string $component The frankenstyle name of the component creating the exemption (e.g. 'gradepenalty_duedate').
    ...
    public static function exempt_user(
        ...
        $exem = penalty_exemption::find_by([
            'component' => $component,
    ...
    public static function get_context_path(context $context): array {
        $contextids = explode('/', $context->path ?? '');
        $contextids = array_filter($contextids, fn($contextid): bool =>
            is_number($contextid) && in_array(
                context::instance_by_id($contextid)->contextlevel,
     ...
     * @param string|null $component Filter exemptions created by a specific component.
     *
     * @return bool
     */
    private static function user_exemption_exists(int $userid, array $contextids, ?string $component = null): bool {
        $criteria = [
            'itemtype' => self::TYPE_USER,
            'itemid' => $userid,
     ...
     * @return bool
     */
    private static function group_exemption_exists(int $groupid, array $contextids, ?string $component = null): bool {
        $criteria = [
            'itemtype' => self::TYPE_GROUP,
            'itemid' => $groupid,
            'contextid' => $contextids,

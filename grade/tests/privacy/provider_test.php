...
final class provider_test extends provider_testcase {
    ...
    public function test_delete_data_for_all_users_in_context(): void {
        ...
        penalty_exemption::exempt_user('core_grades', $u1->id, $c2ctx->id);
        penalty_exemption::exempt_user('core_grades', $u2->id, $c2ctx->id);
    ...
    public function test_delete_data_for_user(): void {
        ...
        penalty_exemption::exempt_user('core_grades', $u1->id, $c1ctx->id);
        penalty_exemption::exempt_user('core_grades', $u1->id, $c2ctx->id);
    ...
    public function test_delete_data_for_users(): void {
        ...
        penalty_exemption::exempt_user('core_grades', $u1->id, $c1ctx->id);
        penalty_exemption::exempt_user('core_grades', $u2->id, $c2ctx->id);
        $ex3 = penalty_exemption::exempt_user('core_grades', $u3->id, $c2ctx->id);
        $ex3->save($u4->id);

...
final class penalty_indicator_test extends advanced_testcase {
    ...
    public static function export_for_template_provider(): array {
        return [
            ...
            [
                'html' => <<<EOD
<div class="penalty-indicator text-danger" title="Late penalty applied -10 marks">
        <span class="penalty-indicator icon">
...
EOD,
    ...
    public function test_export_for_template(string $expectedhtml, array $icon, float $penalty,
        ...
        global $PAGE;
        $indicator = new \core_grades\output\penalty_indicator($icon, $penalty, $finalgrade, $maxgrade);
